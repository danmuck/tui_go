...
func TestVisualComponents(t *testing.T) {
	...
	Configure(Config{
		NoColor: false,
		Colors: ColorConfig{
			Title:   smplog.StyleColor256(15), // bright white
			Menu:    smplog.StyleColor256(14), // bright cyan
			Prompt:  smplog.StyleColor256(10), // bright green
			Data:    smplog.StyleColor256(7),  // white
			Divider: smplog.StyleColor256(8),  // gray
		},
		TUI: TUIConfig{
			MaxWidth:             48,
			Centered:             true,
